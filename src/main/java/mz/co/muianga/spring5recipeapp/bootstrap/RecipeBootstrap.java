package mz.co.muianga.spring5recipeapp.bootstrap;

import lombok.extern.slf4j.Slf4j;
import mz.co.muianga.spring5recipeapp.domain.*;
import mz.co.muianga.spring5recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        log.debug("Loading bootstra data");
    }
